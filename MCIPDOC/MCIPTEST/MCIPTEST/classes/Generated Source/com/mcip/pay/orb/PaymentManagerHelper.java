 ...
 * </pre>
 */
public final class PaymentManagerHelper {
  public static com.mcip.pay.orb.PaymentManager narrow (final org.omg.CORBA.Object obj) {
    return narrow(obj, false);
  }

  public static com.mcip.pay.orb.PaymentManager unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static com.mcip.pay.orb.PaymentManager narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof com.mcip.pay.orb.PaymentManager) {
      return (com.mcip.pay.orb.PaymentManager)obj;
    }
    if (is_a || obj._is_a(id())) {
      final org.omg.CORBA.portable.ObjectImpl _obj = (org.omg.CORBA.portable.ObjectImpl)obj;
      com.mcip.pay.orb._PaymentManagerStub result = new com.mcip.pay.orb._PaymentManagerStub();
  ...
  public static com.mcip.pay.orb.PaymentManager bind (org.omg.CORBA.ORB orb, java.lang.String fullPoaName, byte[] oid) {
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (com.mcip.pay.orb.PaymentManager)obj);
  }
  ...
  public static com.mcip.pay.orb.PaymentManager read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(com.mcip.pay.orb._PaymentManagerStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final com.mcip.pay.orb.PaymentManager _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final com.mcip.pay.orb.PaymentManager _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, com.mcip.pay.orb.PaymentManagerHelper.type());
  }

  public static com.mcip.pay.orb.PaymentManager extract (final org.omg.CORBA.Any any) {
    com.mcip.pay.orb.PaymentManager _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = com.mcip.pay.orb.PaymentManagerHelper.narrow(_obj);
    return _vis_value;
  }
