 ...
 * </pre>
 */
public final class staticInfoManagerHelper {
  public static com.mcip.cdt.orb.staticInfoManager narrow (final org.omg.CORBA.Object obj) {
    return narrow(obj, false);
  }

  public static com.mcip.cdt.orb.staticInfoManager unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static com.mcip.cdt.orb.staticInfoManager narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof com.mcip.cdt.orb.staticInfoManager) {
      return (com.mcip.cdt.orb.staticInfoManager)obj;
    }
    if (is_a || obj._is_a(id())) {
      final org.omg.CORBA.portable.ObjectImpl _obj = (org.omg.CORBA.portable.ObjectImpl)obj;
      com.mcip.cdt.orb._staticInfoManagerStub result = new com.mcip.cdt.orb._staticInfoManagerStub();
  ...
  public static com.mcip.cdt.orb.staticInfoManager bind (org.omg.CORBA.ORB orb, java.lang.String fullPoaName, byte[] oid) {
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (com.mcip.cdt.orb.staticInfoManager)obj);
  }
  ...
  public static com.mcip.cdt.orb.staticInfoManager read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(com.mcip.cdt.orb._staticInfoManagerStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final com.mcip.cdt.orb.staticInfoManager _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final com.mcip.cdt.orb.staticInfoManager _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, com.mcip.cdt.orb.staticInfoManagerHelper.type());
  }

  public static com.mcip.cdt.orb.staticInfoManager extract (final org.omg.CORBA.Any any) {
    com.mcip.cdt.orb.staticInfoManager _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = com.mcip.cdt.orb.staticInfoManagerHelper.narrow(_obj);
    return _vis_value;
  }
