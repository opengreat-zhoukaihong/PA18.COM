 ...
 * </pre>
 */
public final class BusinessManagerHelper {
  public static com.mcip.bus.orb.BusinessManager narrow (final org.omg.CORBA.Object obj) {
    return narrow(obj, false);
  }

  public static com.mcip.bus.orb.BusinessManager unchecked_narrow (org.omg.CORBA.Object obj) {
    return narrow(obj, true);
  }

  private static com.mcip.bus.orb.BusinessManager narrow (final org.omg.CORBA.Object obj, final boolean is_a) {
    if (obj == null) {
      return null;
    }
    if (obj instanceof com.mcip.bus.orb.BusinessManager) {
      return (com.mcip.bus.orb.BusinessManager)obj;
    }
    if (is_a || obj._is_a(id())) {
      final org.omg.CORBA.portable.ObjectImpl _obj = (org.omg.CORBA.portable.ObjectImpl)obj;
      com.mcip.bus.orb._BusinessManagerStub result = new com.mcip.bus.orb._BusinessManagerStub();
  ...
  public static com.mcip.bus.orb.BusinessManager bind (org.omg.CORBA.ORB orb, java.lang.String fullPoaName, byte[] oid) {
  ...
  public void write_Object (final org.omg.CORBA.portable.OutputStream ostream, final java.lang.Object obj) {
    ...
    write(ostream, (com.mcip.bus.orb.BusinessManager)obj);
  }
  ...
  public static com.mcip.bus.orb.BusinessManager read (final org.omg.CORBA.portable.InputStream _input) {
    return narrow(_input.read_Object(com.mcip.bus.orb._BusinessManagerStub.class), true);
  }

  public static void write (final org.omg.CORBA.portable.OutputStream _output, final com.mcip.bus.orb.BusinessManager _vis_value) {
  ...
  public static void insert (final org.omg.CORBA.Any any, final com.mcip.bus.orb.BusinessManager _vis_value) {
    any.insert_Object((org.omg.CORBA.Object)_vis_value, com.mcip.bus.orb.BusinessManagerHelper.type());
  }

  public static com.mcip.bus.orb.BusinessManager extract (final org.omg.CORBA.Any any) {
    com.mcip.bus.orb.BusinessManager _vis_value;
    final org.omg.CORBA.Object _obj = any.extract_Object();
    _vis_value = com.mcip.bus.orb.BusinessManagerHelper.narrow(_obj);
    return _vis_value;
  }
