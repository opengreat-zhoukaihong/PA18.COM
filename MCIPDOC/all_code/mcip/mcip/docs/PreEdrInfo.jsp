...
<%
     PlyNoDisp= request.getParameter("C_DOC_NO");
    try
    {
...
<p align="center"><font size="4"><u><font size="4"><%=TransitName%></font>货物运输保险批单预览</u></font></p>
<p align="center">&nbsp;</p>
<form >
  <div align="center"> 
    <center>
...
<form>
    ...
    <tr> 
      <td  colspan="2">批单号<br>Policy NO：<%=PlyNoDisp%>
