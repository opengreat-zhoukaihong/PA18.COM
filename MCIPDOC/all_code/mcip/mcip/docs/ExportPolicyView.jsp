...
<div align="left">
	<table border="0" width="760" cellspacing="0" cellpadding="0" height="8">
		...
		<tr>
			...
			<td width="282" height="66" rowspan="3" valign="top"><font face="宋体" size="2" color="blue"><%=Objects.getHt(hashData,"C_PAY_ADDR")%> IN <%=currencyInfo[1][indexCurSbl]%></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="277" height="39" colspan="3"><font face="宋体" size="2" color="blue"><% if (Objects.getHt(hashData,"C_INVC_NO").trim().length() > 0)
		...
		<tr>
			...
			Survey By</font></td>
			<td width="282" height="129" rowspan="5" valign="top">
			<font face="宋体" size="2" color="blue"><%=StringTool.nl2br(Objects.getHt(hashData,"C_SRVY_CNM"))%></font>
		</td>
		</tr>
		<tr>
			<td width="390" height="19" colspan="4">
		...
		<%if (Objects.getHt(hashData,"C_PRN_FRM").trim().length() > 0)
				...
				out.println(StringTool.getDateString(Objects.getHt(hashData,"T_INSRNC_BGN_TM"),language));%></font></td>
...
<table width="778" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="80%">
			<font color="blue">			<%if(language.equals("ENG"))
