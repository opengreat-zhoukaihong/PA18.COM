...
<%
   ...
   if(MenuRef.equals("FindPrp"))
   {
     //Cnm = Const.PRP_CNM;      
	 Cnm = Const.PLYAPP_CNM;
     Pic = "images/jyscx.gif";
     AgencyValue = Const.PRP;
   }
   else if(MenuRef.equals("FindPly"))
   {
     Cnm = Const.PLY_CNM;      
     Pic = "images/m_inq2.gif";
     AgencyValue = Const.CASE;
   }
   else if(MenuRef.equals("MENU_REPORT"))
   {
     Cnm = Const.PLY_CNM;      
     Pic = "images/m_inq2.gif";
     AgencyValue = Const.CASE;
   }else if(MenuRef.equals("FindEdrSmtApp")){
     Cnm = "批改申请单";
     AgencyValue = Const.EDRSMTAPP;	 
	 Pic = "images/pigaicx-b.gif";
   }else if(MenuRef.equals("FindEdrSmt")){
     Cnm = "批单";
	 AgencyValue = Const.EDRSMT;
	 Pic = "images/pidancx-b.gif";
   }
