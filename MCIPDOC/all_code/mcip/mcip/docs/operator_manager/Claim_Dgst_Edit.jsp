...
if (action.equals("add")){
	...
	try
	{		 
		bb.setFormPara(BConst.UPDATE_CLMDGST,formPara);
...
%>
	...
	<% if (!action.equals("add")){%>
	<form name="f" method="POST" action="Claim_Dgst_Edit.jsp">
		...
		<table width="96%" border="1" cellspacing="0" cellpadding="0" align="center" class="td" bordercolor="#009999" bordercolorlight="#E6E6E6">
			...
			<tr> 
				...
				<td bgcolor="#DFF9F3" width="81%">
					<input type="text" name="claimDgst" size="50" maxlength="50" value="<%=StringTool.htmlEncode(claimDgst)%>">
				</td>
			</tr>
			<tr bgcolor="#FFFFFF">
				<td bgcolor="#9DEEDE" width="19%">
				...
				<td bgcolor="#DFF9F3" width="81%">
					<textarea name="claimContent" rows="7" cols="60"><%=StringTool.htmlEncode(claimContent)%></textarea>
			</td>
		  </tr>
	</table>
	<div align="center">
...
<%	}else{%>
		<table border ="0" width = "100%" valign="center" align = "center">
			<tr>
				<td align="center" ><h1>赔案摘要信息修改失败！</h1></td>
			</tr>
			<tr>
				<form action="Claim_Dgst_List.jsp">
				<input type="hidden" name="index" value="0">
