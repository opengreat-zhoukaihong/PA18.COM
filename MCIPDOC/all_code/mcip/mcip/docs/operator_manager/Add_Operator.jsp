...
<form name="form1"  action="addOperatorAction.jsp" onSubmit= "return (ValidNull(C_OPR_CDE,false) && ValidInvaKey(C_OPR_CDE) && ValidOprPsw(C_OPR_PW,false) && ValidNull(ConfirmPw ,false) && ValidSame(C_OPR_PW , ConfirmPw) && ValidNull(C_EMP_CDE ,false));" >
<div align="center">
        <div align="center">
          <div align="center"><font color="#0066CC"><span class="unnamed3">增加后台操作员</span></font><br>
            <br>
          </div>
          <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" class="td">
            <tr> 
              ...
              <td width="82%"> 
                <input type="text" name="C_OPR_CDE"  maxlength="10">
            ...
            <tr> 
              ...
              <td width="82%"> 
                <input type="text" name="C_EMP_CDE" maxlength="10">
