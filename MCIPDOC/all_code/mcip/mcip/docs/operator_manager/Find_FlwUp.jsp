...
<div align="center"><font color="#0066CC" class="unnamed3">报案信息查询</font><br>
...
<table width="96%" border="1" cellspacing="0" cellpadding="0" align="center" class="td" bordercolor="#009999" bordercolorlight="#E6E6E6">
	...
	<td bgcolor="#DFF9F3" colspan="3" height="19">查询所有信息</td>
	</tr>
	<tr> 
	<td bgcolor="#DFF9F3" width="4%" height="19"> 
	  <div align="center"> 
	...
	<td bgcolor="#DFF9F3" colspan="3" height="17">是否立案（ 
	...
	<td bgcolor="#DFF9F3" colspan="3" height="11">报 案 号: 
	...
	<td bgcolor="#DFF9F3" colspan="3">投保时间范围：<br>从
	...
	<td bgcolor="#DFF9F3" colspan="3" height="24">险种码： 从: 
