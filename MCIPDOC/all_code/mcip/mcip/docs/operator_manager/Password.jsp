...
<%
	   ...
	   c_opr_cde = sessionuser.getuserId(Locate); 
	   c_emp_cde = sessionuser.getemployeCode(Locate); 

    %>
<form name="form1" method ="post" action="PwAction.jsp" onSubmit = "return (ValidNull(C_OPR_CDE,false) && ValidInvaKey(C_OPR_CDE) && ValidOprPsw(C_OPR_PW,false) && ValidNull(ConfirmPw ,false) && ValidSame(C_OPR_PW , ConfirmPw) && ValidNull(C_EMP_CDE ,false));" >
<div align="center">
        <div align="center">
          <div align="center"><font color="#0066CC"><span class="unnamed3">修改我的密码</span></font><br>
            <br>
          </div>
          <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" class="td">
            <tr> 
              <td width="18%"> 
                <div align="right">我的帐号：</div>
              </td>
              <td width="82%"> 
                <input type="text" name="disp"  maxlength="10" value="<%=c_opr_cde%>" disabled>
				<input type="hidden" name="C_OPR_CDE"  maxlength="10" value="<%=c_opr_cde%>" >
            ...
            <tr> 
              ...
              <td width="82%"> 
                <input type="text" name="dsp"  maxlength="10" value="<%=c_emp_cde%>" disabled>
				<input type="hidden" name="C_EMP_CDE"  maxlength="10" value="<%=c_emp_cde%>" >
