...
%>
    ...
    <table width="90%" border="1" cellspacing="1" cellpadding="0" bordercolor="#CCCCFF" bordercolorlight="#0099FF" bordercolordark="#FFFFFF">
      ...
      <form name="form1" method="POST" action="view_rpt_info.jsp">
    		 <tr bgcolor="#FFFFFF">
      			<td width="20%" height="16"><a href="#Page" title="点击选择" onclick="selectNo(selectno,<%=i+t1-1%>);return true"><%=Objects.getValue(i,"C_RPT_NO",info)%></a>&nbsp;</td>
	     			<td width="13%" height="16"><%=Objects.getValue(i,"T_RTP_TM",info)%>&nbsp;</td>
       			<td width="20%" height="16"><%=Objects.getValue(i,"c_ply_no",info)%>&nbsp;</td>
      			<td width="13%" height="16"><%=Objects.getValue(i,"C_INSRNT_NME",info)%>&nbsp;</td>
      			<td width="10%" height="16"><%=Objects.getValue(i,"N_RPT_AMT",info)%>&nbsp;</td>
      			<td width="24%" height="16"><%=Objects.getValue(i,"C_CRGO_DESC",info)%>&nbsp;</td>
    			  </tr>
      	<%	}
			 %>
          <tr> 
