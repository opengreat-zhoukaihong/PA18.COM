...
<p>
<ul>
<li> <b>Java Class</b> com.mcip.nia.orb._tie_PolicyManager
<li> <b>Source File</b> com/mcip/nia/orb/_tie_PolicyManager.java
...
*/
public class _tie_PolicyManager extends com.mcip.nia.orb._PolicyManagerImplBase {
  private com.mcip.nia.orb.PolicyManagerOperations _delegate;
  public _tie_PolicyManager(com.mcip.nia.orb.PolicyManagerOperations delegate, java.lang.String name) {
    super(name);
    this._delegate = delegate;
  }
  public _tie_PolicyManager(com.mcip.nia.orb.PolicyManagerOperations delegate) {
    this._delegate = delegate;
  }
  ...
  */
  public java.lang.String[][] acceptCaseRpt(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptCaseRpt(
      caserptinfoobj
    );
  }
  /**
  ...
  */
  public java.lang.String[][] acceptPolicyEdr(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptPolicyEdr(
      plyedrappinfoobj,
  ...
  */
  public boolean withdrawalEdrApp(
    ...
    com.mcip.orb.CoException {
    return this._delegate.withdrawalEdrApp(
      edr_app_no
    );
  }
  /**
  ...
  */
  public java.lang.String[][] confirmEdrAppProposal(
    ...
    com.mcip.orb.CoException {
    return this._delegate.confirmEdrAppProposal(
      edrapp_no,
      dpt_cde,
      insrnc_cde
    );
  ...
  */
  public boolean deleteEdrApp(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deleteEdrApp(
      edr_app_no
    );
  }
}
