...
<p>
<ul>
<li> <b>Java Class</b> com.mcip.bus.orb.OprDptInfoHelper
<li> <b>Source File</b> com/mcip/bus/orb/OprDptInfoHelper.java
...
*/
abstract public class OprDptInfoHelper {
  private static org.omg.CORBA.ORB _orb() {
    return org.omg.CORBA.ORB.init();
  }
  public static com.mcip.bus.orb.OprDptInfo read(org.omg.CORBA.portable.InputStream _input) {
    com.mcip.bus.orb.OprDptInfo result = new com.mcip.bus.orb.OprDptInfo();
    result.c_opr_cde = _input.read_string();
    result.c_dpt_cde = _input.read_string();
    return result;
  }
  public static void write(org.omg.CORBA.portable.OutputStream _output, com.mcip.bus.orb.OprDptInfo value) {
    _output.write_string(value.c_opr_cde);
    _output.write_string(value.c_dpt_cde);
  }
  public static void insert(org.omg.CORBA.Any any, com.mcip.bus.orb.OprDptInfo value) {
    org.omg.CORBA.portable.OutputStream output = any.create_output_stream();
    write(output, value);
    any.read_value(output.create_input_stream(), type());
  }
  public static com.mcip.bus.orb.OprDptInfo extract(org.omg.CORBA.Any any) {
