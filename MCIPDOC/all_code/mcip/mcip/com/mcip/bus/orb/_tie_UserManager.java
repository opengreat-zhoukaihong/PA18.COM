...
<p>
<ul>
<li> <b>Java Class</b> com.mcip.bus.orb._tie_UserManager
<li> <b>Source File</b> com/mcip/bus/orb/_tie_UserManager.java
...
*/
public class _tie_UserManager extends com.mcip.bus.orb._UserManagerImplBase {
  private com.mcip.bus.orb.UserManagerOperations _delegate;
  public _tie_UserManager(com.mcip.bus.orb.UserManagerOperations delegate, java.lang.String name) {
    super(name);
    this._delegate = delegate;
  }
  public _tie_UserManager(com.mcip.bus.orb.UserManagerOperations delegate) {
    this._delegate = delegate;
  }
  ...
  */
  public java.lang.String[][] operatorLogin(
    ...
    com.mcip.orb.CoException {
    return this._delegate.operatorLogin(
      usrname,
      passwd
    );
  }
  ...
  */
  public boolean acceptOperator(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptOperator(
      operatorinfoobj
    );
  }
  /**
  ...
  */
  public boolean updateOperator(
    ...
    com.mcip.orb.CoException {
    return this._delegate.updateOperator(
      operatorinfoobj
    );
  }
  /**
  ...
  */
  public boolean deleteOperator(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deleteOperator(
      auth_dpt_cde,
      auth_opr_cde,
      del_opr_cde,
      rcsv_del_flg
  ...
  */
  public java.lang.String[][] queryOptrInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryOptrInfo(
      in_opr_cde
    );
  }
  /**
  ...
  */
  public java.lang.String[][] queryOptrList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryOptrList(
      in_opr_cde,
      in_emp_cde,
      adm_opr_cde,
      adm_dpt_cde
  ...
  */
  public java.lang.String[][] queryAuthList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryAuthList(
      in_opr_cde,
      in_emp_cde,
      adm_opr_cde,
      adm_dpt_cde
  ...
  */
  public boolean acceptOptrAuth(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptOptrAuth(
      oprauthInfoobj,
      oprdptinfoobj
    );
  }
  ...
  */
  public boolean updateOptrAuth(
    ...
    com.mcip.orb.CoException {
    return this._delegate.updateOptrAuth(
      oprauthInfoobj,
      oprdptinfoobj
    );
  }
  ...
  */
  public boolean deleteOptrAuth(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deleteOptrAuth(
      in_opr_cde,
      in_func_cde
    );
  }
  ...
  */
  public java.lang.String[][] queryOptrDptList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryOptrDptList(
      in_opr_cde
    );
  }
  /**
  ...
  */
  public java.lang.String[][] queryAbleDptList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryAbleDptList(
      in_opr_cde,
      auth_opr_cde
    );
  }
  ...
  */
  public boolean acceptSysFunc(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptSysFunc(
      sysfuncinfoobj
    );
  }
  /**
  ...
  */
  public boolean updateSysFunc(
    ...
    com.mcip.orb.CoException {
    return this._delegate.updateSysFunc(
      sysfuncinfoobj
    );
  }
  /**
  ...
  */
  public boolean deleteSysFunc(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deleteSysFunc(
      in_func_cde
    );
  }
  /**
  ...
  */
  public java.lang.String[][] querySysFuncList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.querySysFuncList(
      in_func_cde
    );
  }
  /**
  ...
  */
  public boolean acceptPagesInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptPagesInfo(
      pagesinfoobj
    );
  }
  /**
  ...
  */
  public boolean updatePagesInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.updatePagesInfo(
      pagesinfoobj
    );
  }
  /**
  ...
  */
  public boolean deletePagesInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deletePagesInfo(
      in_page_no
    );
  }
  /**
  ...
  */
  public java.lang.String[][] queryPagesList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryPagesList(
      in_func_cde
    );
  }
  /**
  ...
  */
  public boolean executeOptrAuth(
    ...
    com.mcip.orb.CoException {
    return this._delegate.executeOptrAuth(
      act_typ,
      auth_opr_cde,
      in_opr_cde,
      oprauthInfo,
  ...
  */
  public boolean checkOptrAuth(
    ...
    com.mcip.orb.CoException {
    return this._delegate.checkOptrAuth(
      in_optr_cde,
      in_func_cde
    );
  }
  ...
  */
  public java.lang.String[][] queryCustEnttList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryCustEnttList(
      in_opr_cde,
      in_verify_flg,
      in_dpt_cde,
      frm_crt_tm,
  ...
  */
  public java.lang.String[][] querySameCustList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.querySameCustList(
      in_clnt_cnm
    );
  }
  /**
  ...
  */
  public boolean acceptUserVerify(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptUserVerify(
      in_user_id,
      in_clnt_cde,
      in_cmpny_agt_cde,
      in_verify_flg,
  ...
  */
  public boolean replaceAuthOptr(
    ...
    com.mcip.orb.CoException {
    return this._delegate.replaceAuthOptr(
      org_optr_cde,
      trgt_optr_cde
    );
  }
  ...
  */
  public boolean compareAuthDptOptr(
    ...
    com.mcip.orb.CoException {
    return this._delegate.compareAuthDptOptr(
      org_optr_cde,
      trgt_optr_cde
    );
  }
  ...
  */
  public java.lang.String[][] queryOptrAuthList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryOptrAuthList(
      in_opr_cde
    );
  }
  /**
  ...
  */
  public java.lang.String[][] querySubDptList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.querySubDptList(
      in_dpt_cde
    );
  }
  /**
  ...
  */
  public boolean acceptClntMapInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptClntMapInfo(
      opr_cde,
      clnt_agt_flg,
      user_id,
      clnt_cde,
  ...
  */
  public boolean updateClntMapInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.updateClntMapInfo(
      opr_cde,
      clnt_agt_flg,
      new_user_id,
      new_clnt_cde,
  ...
  */
  public boolean deleteClntMapInfo(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deleteClntMapInfo(
      opr_cde,
      user_id,
      clnt_cde,
      clnt_agt_flg
  ...
  */
  public java.lang.String[][] queryClntMapList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.queryClntMapList(
      opr_cde,
      user_id
    );
  }
  ...
  */
  public boolean executeSysadmAuth(
    ...
    com.mcip.orb.CoException {
    return this._delegate.executeSysadmAuth(
      act_typ,
      auth_opr_cde,
      in_opr_cde,
      in_dpt_cde
  ...
  */
  public java.lang.String[][] getDptCEnm(
    ...
    com.mcip.orb.CoException {
    return this._delegate.getDptCEnm(
      dpt_cde,
      cenm_typ
    );
  }
  ...
  */
  public boolean acceptSuppEmail(
    ...
    com.mcip.orb.CoException {
    return this._delegate.acceptSuppEmail(
      emp_cde,
      emp_nme,
      dpt_cde,
      emp_type,
  ...
  */
  public boolean updateSuppEmail(
    ...
    com.mcip.orb.CoException {
    return this._delegate.updateSuppEmail(
      emp_cde,
      emp_nme,
      dpt_cde,
      emp_type,
  ...
  */
  public boolean deleteSuppEmail(
    ...
    com.mcip.orb.CoException {
    return this._delegate.deleteSuppEmail(
      supp_no
    );
  }
  /**
  ...
  */
  public java.lang.String[][] querySuppEmailList(
    ...
    com.mcip.orb.CoException {
    return this._delegate.querySuppEmailList(
      emp_nme,
      dpt_cde,
      emp_type
    );
